                ...
                <div class="flex flex-col items-center gap-2">
                    ...
                    <div id="seasonDropdown" class="flex flex-col justify-center items-start gap-4 py-2 px-4 bg-[#800000] rounded-lg hidden">
                        @for($year = 2024; $year <= date('Y'); $year++)
                            <a href="{{ route('score', ['user' => $user_id, 'season' => $year]) }}" class="flex items-center gap-2 border-b pb-1 btn-item">
                                {{ __($year . 'シーズン') }}
                            </a>
                        @endfor
                    </div>
                    ...
                    <div class="flex flex-col items-start gap-2 w-full">
                        ...
                        <div id="pitcher_area" class="flex flex-col items-center gap-2 px-6 overflow-hidden h-0 duration-500 rounded-lg w-full">
                            <div class="flex flex-col gap-2">
                                ...
                                @endif
                                <x-parts.score-item item_name="{{ __('失点') }}" :item_value="$all_data['point'].'点'" />
                                <x-parts.score-item item_name="{{ __('自責点') }}" :item_value="$all_data['earned_run'].'点'" />
